...
Sou desenvolvedor **.NET** em evolução para me tornar **Full Stack**, com formação em **Análise e Desenvolvimento de Sistemas** e atualmente estou cursando **Sistemas para Internet** na **Estácio** e possuo experiência prática no desenvolvimento de aplicações utilizando **C#, .NET e SQL Server**.
